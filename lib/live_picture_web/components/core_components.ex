defmodule LivePictureWeb.CoreComponents do
  @moduledoc """
          ...
          <div class="w-full max-w-3xl p-4 sm:p-6 lg:py-8">
            ...
            >
              <div class="absolute top-6 right-5">
                ...
                >
                  <.icon name="hero-x-mark-solid" class="bg-black h-5 w-5" />
                </button>
              </div>
              <div id={"#{@id}-content"}>
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(LivePictureWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(LivePictureWeb.Gettext, "errors", msg, opts)
    end
  end
